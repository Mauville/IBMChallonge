...
let getInfo = (formJSON)=>{
  // let sanitizedJSON = sanitize(formJSON);
...
let day = data.date.date();
let month = data.date.month();
let p1 = data.energy[0];
let p2 = data.energy[1];
let p3 = data.energy[2];
let p4 = data.energy[3];
let p5 = data.energy[5];
let p6 = data.energy[4];
